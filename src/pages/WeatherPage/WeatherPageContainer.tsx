...
const WeatherPage = lazy(() => import('./WeatherPage').then((module) => ({ default: module.WeatherPage })))
...
export const WeatherPageContainer = compose<ComponentType>(
    connect(mapStateToProps, { setHeaderTitle, setLocationValue, getActualWeather }),
    withAuthRedirect,
    withLazyLoading)
(WeatherPage)
