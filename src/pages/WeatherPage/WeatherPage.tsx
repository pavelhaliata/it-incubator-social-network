      ...
      <div className={style.weather}>
        ...
        <div className={style.weather__now}>
          ...
          {this.props.weatherData.weather[0].icon && (
            <img
              src={`https://openweathermap.org/img/wn/${this.props.weatherData.weather[0].icon}@2x.png`}
              alt="icon"
            />
          )}
        </div>
        <div className={style.weather_description}>
          ...
          <span>
            Real Feel:{" "}
            <span>
              {Math.round(this.props.weatherData.main.feels_like)}&deg;
            </span>
          </span>
          <span>
          ...
          <span>
            Wind:{" "}
            <span>{this.props.weatherData.wind.speed.toFixed(1)} m/s</span>
          </span>
        </div>
        ...
        >
          <input
            ...
            placeholder={
              this.props.errorStatus ? this.props.errorStatus : "City search..."
            }
          />
          <Button
            label="Find city"
