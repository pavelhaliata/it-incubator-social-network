...
export const User = (props: UserPagePropsType) => {
  ...
  const userAvatar = props.userProfileData.photos.small
    ? props.userProfileData.photos.small
    : defaultAvatar;
    ...
    <div className={style.wrapper}>
      {props.requestStatus === RequestStatus.loading ? (
        ...
        <div className={`${style.card}`}>
          {jobSearchStatus && (
            <div className={style.jobSearchStatus}>open to work</div>
          )}
              ...
              {props.userProfileData.contacts.twitter && (
                <li className={style.item}>
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    href={props.userProfileData.contacts.twitter}
                  >
                    <img src={twitter} alt="" />
                  </a>
                </li>
              ...
              {props.userProfileData.contacts.vk && (
                <li className={style.item}>
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    href={props.userProfileData.contacts.vk}
                  >
                    <img src={vk} alt="" />
                  </a>
                </li>
              ...
              {props.userProfileData.contacts.youtube && (
                <li className={style.item}>
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    href={props.userProfileData.contacts.youtube}
                  >
                    <img src={youtube} alt="" />
                  </a>
                </li>
              ...
              {props.userProfileData.contacts.github && (
                <li className={style.item}>
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    href={props.userProfileData.contacts.github}
                  >
                    <img src={github} alt="" />
                  </a>
                </li>
              ...
              {props.userProfileData.contacts.website && (
                <li className={style.item}>
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    href={props.userProfileData.contacts.website}
                  >
                    <img src={website} alt="" />
                  </a>
                </li>
