        ...
        <div className={style.card_wrapper}>
          <div className={style.card}>
            ...
            <div className={style.btn_wrapper}>
              {this.props.followed ? (
                  <Button className={`${style.btn_person} ${style.unfollow}`} onClick={this.props.unFollowUser} disabled={this.props.selectedCurrentUser.some(i => i === this.props.id)} >
                    unfollow
                  </Button>
              ) : (
                  <Button className={`${style.btn_person}`} onClick={this.props.followUser} disabled={this.props.selectedCurrentUser.some(i => i === this.props.id)}>
                    follow
                  </Button>
              )}
            </div>
