        ...
        <div className={style.card}>
          ...
          <div className={style.card_body}>
            <div className={style.author_avatar}>
              <img
                src={this.props.avatar ? this.props.avatar : defaultAvatar}
                alt="avatar"
              />
            </div>
          ...
          <div className={style.btn_wrapper}>
            {this.props.followed ? (
              <Button
                label="Unfollow"
                className={`${style.btn_person} ${style.unfollow}`}
                onClick={this.props.unFollowUser}
                disabled={this.props.selectedCurrentUser.some(
                  (i) => i === this.props.id
                )}
              />
            ) : (
