...
import topHeader from "../../assets/images/top-header.webp";
import author from "../../assets/images/author-main.webp";
      ...
      <div className={`${style.profile_container}`}>
        <div className={style.profile_header}>
          <div className={style.header_banner}>
            <img className={style.banner} src={topHeader} alt="img" />
          </div>
          ...
          <div className={style.header_author}>
            <a href="#" className={style.author_img}>
              <img src={author} alt="author" width="124px" height="124px" />
            </a>
